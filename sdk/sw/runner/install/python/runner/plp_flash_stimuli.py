...
class FlashImage(object):
    ...
    def __dumpFlashHeader_v2(self):
        ...
        print ("crc_offset: %d, flashOffset: %d, header_buff len: %d" % (crc_offset, self.flashOffset, len(header_buff)) )
        ...
        print ("header_buff:", len(header_buff))
