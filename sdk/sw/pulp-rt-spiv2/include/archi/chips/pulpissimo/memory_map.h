...
#define ARCHI_GPIO_OFFSET            0x00000000
#define ARCHI_ANALOG_IF_OFFSET       0x00000800
#define ARCHI_APB_SOC_CTRL_OFFSET    0x00001000
#define ARCHI_SOC_EU_OFFSET          0x00002000
#define ARCHI_SOC_I2C_SLAVER_OFFSET  0x00003000
#define ARCHI_HGM_OFFSET             0x00003800
#define ARCHI_FC_ITC_OFFSET          0x00005800
#define ARCHI_FC_TIMER_OFFSET        0x00007000
#define ARCHI_STDOUT_OFFSET          0x00008000

#define ARCHI_UDMA_OFFSET            0x00004000
#define ARCHI_FLL_OFFSET             0x0000a000
...
#define ARCHI_I2C_SLAVER_ADDR        ( ARCHI_SOC_PERIPHERALS_ADDR + ARCHI_SOC_I2C_SLAVER_OFFSET )
#define ARCHI_HGM_ADDR               ( ARCHI_SOC_PERIPHERALS_ADDR + ARCHI_HGM_OFFSET )
#define ARCHI_ANALOG_IF_ADDR         ( ARCHI_SOC_PERIPHERALS_ADDR + ARCHI_ANALOG_IF_OFFSET )
