...
// //modify by guan
// static inline void apb_soc_histogram_capt_enable(unsigned int value) {
//   pulp_write32(ARCHI_APB_SOC_CTRL_ADDR + APB_SOC_HISTOGRAM_CAPT_ENABLE_OFFSET, value);
// }
// static inline void apb_soc_histogram_hold_enable(unsigned int value) {
//   pulp_write32(ARCHI_APB_SOC_CTRL_ADDR + APB_SOC_HISTOGRAM_HOLD_ENABLE_OFFSET, value);
// }
