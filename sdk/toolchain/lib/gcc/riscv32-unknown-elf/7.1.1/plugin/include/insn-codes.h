...
enum insn_code {
  ...
  CODE_FOR_addcv3 = 1003,
  CODE_FOR_subcv3 = 1004,
  CODE_FOR_smincv3 = 1005,
  CODE_FOR_smaxcv3 = 1006,
  CODE_FOR_mulcv3 = 1007,
  CODE_FOR_addnv3 = 1008,
  CODE_FOR_subnv3 = 1009,
  CODE_FOR_sminnv3 = 1010,
  CODE_FOR_smaxnv3 = 1011,
  CODE_FOR_mulnv3 = 1012,
  CODE_FOR_addsccv3 = 1013,
  CODE_FOR_subsccv3 = 1014,
  CODE_FOR_sminsccv3 = 1015,
  CODE_FOR_smaxsccv3 = 1016,
  CODE_FOR_mulsccv3 = 1017,
  CODE_FOR_addscnv3 = 1018,
  CODE_FOR_subscnv3 = 1019,
  CODE_FOR_sminscnv3 = 1020,
  CODE_FOR_smaxscnv3 = 1021,
  CODE_FOR_mulscnv3 = 1022,
  CODE_FOR_umincv3 = 1023,
  CODE_FOR_umaxcv3 = 1024,
  CODE_FOR_uminnv3 = 1025,
  CODE_FOR_umaxnv3 = 1026,
  CODE_FOR_uminsccv3 = 1027,
  CODE_FOR_umaxsccv3 = 1028,
  CODE_FOR_uminscnv3 = 1029,
  CODE_FOR_umaxscnv3 = 1030,
  CODE_FOR_vlshrcv3 = 1031,
  CODE_FOR_vashrcv3 = 1032,
  CODE_FOR_vashlcv3 = 1033,
  CODE_FOR_vlshrnv3 = 1034,
  CODE_FOR_vashrnv3 = 1035,
  CODE_FOR_vashlnv3 = 1036,
  CODE_FOR_vlshrsccv3 = 1037,
  CODE_FOR_vashrsccv3 = 1038,
  CODE_FOR_vashlsccv3 = 1039,
  CODE_FOR_vlshrscnv3 = 1040,
  CODE_FOR_vashrscnv3 = 1041,
  CODE_FOR_vashlscnv3 = 1042,
  CODE_FOR_andcv3 = 1043,
  CODE_FOR_iorcv3 = 1044,
  CODE_FOR_exorcv3 = 1045,
  CODE_FOR_andnv3 = 1046,
  CODE_FOR_iornv3 = 1047,
  CODE_FOR_exornv3 = 1048,
  CODE_FOR_andsccv3 = 1049,
  CODE_FOR_iorsccv3 = 1050,
  CODE_FOR_exorsccv3 = 1051,
  CODE_FOR_andscnv3 = 1052,
  CODE_FOR_iorscnv3 = 1053,
  CODE_FOR_exorscnv3 = 1054,
  CODE_FOR_avgcv3 = 1055,
  CODE_FOR_avgnv3 = 1056,
  CODE_FOR_avgsccv3 = 1057,
  CODE_FOR_avgscnv3 = 1058,
  CODE_FOR_avgucv3 = 1059,
  CODE_FOR_avgunv3 = 1060,
  CODE_FOR_avgusccv3 = 1061,
  CODE_FOR_avguscnv3 = 1062,
  CODE_FOR_abscv2 = 1063,
  CODE_FOR_absnv2 = 1064,
  CODE_FOR_vec_extract_sext_si_cv = 1065,
  CODE_FOR_vec_extract_sext_si_nv = 1066,
  CODE_FOR_vec_extract_zext_si_cv = 1067,
  CODE_FOR_vec_extract_zext_si_nv = 1068,
  CODE_FOR_vec_insert_si_cv = 1069,
  CODE_FOR_vec_insert_si_nv = 1070,
  CODE_FOR_dotupcv = 1071,
  CODE_FOR_dotupnv = 1072,
  CODE_FOR_dotupsccv = 1073,
  CODE_FOR_dotupscnv = 1074,
  CODE_FOR_dotspcv = 1075,
  CODE_FOR_dotspnv = 1076,
  CODE_FOR_dotspsccv = 1077,
  CODE_FOR_dotspscnv = 1078,
  CODE_FOR_dotuspcv = 1079,
  CODE_FOR_dotuspnv = 1080,
  CODE_FOR_dotuspsccv = 1081,
  CODE_FOR_dotuspscnv = 1082,
  CODE_FOR_sdotupcv = 1083,
  CODE_FOR_sdotupnv = 1084,
  CODE_FOR_sdotupsccv = 1085,
  CODE_FOR_sdotupscnv = 1086,
  CODE_FOR_sdotspcv = 1087,
  CODE_FOR_sdotspnv = 1088,
  CODE_FOR_sdotspsccv = 1089,
  CODE_FOR_sdotspscnv = 1090,
  CODE_FOR_sdotuspcv = 1091,
  CODE_FOR_sdotuspnv = 1092,
  CODE_FOR_sdotuspsccv = 1093,
  CODE_FOR_sdotuspscnv = 1094,
  CODE_FOR_qntcv = 1095,
  CODE_FOR_qntnv = 1096,
  CODE_FOR_mlinitspr = 1097,
  CODE_FOR_mlsdotuphv = 1098,
  CODE_FOR_mlsdotupbv = 1099,
  CODE_FOR_mlsdotupcv = 1100,
  CODE_FOR_mlsdotupnv = 1101,
  CODE_FOR_mlsdotusphv = 1102,
  CODE_FOR_mlsdotuspbv = 1103,
  CODE_FOR_mlsdotuspcv = 1104,
  CODE_FOR_mlsdotuspnv = 1105,
  CODE_FOR_mlsdotsuphv = 1106,
  CODE_FOR_mlsdotsupbv = 1107,
  CODE_FOR_mlsdotsupcv = 1108,
  CODE_FOR_mlsdotsupnv = 1109,
  CODE_FOR_mlsdotsphv = 1110,
  CODE_FOR_mlsdotspbv = 1111,
  CODE_FOR_mlsdotspcv = 1112,
  CODE_FOR_mlsdotspnv = 1113,
  CODE_FOR_mem_thread_fence_1 = 1114,
  CODE_FOR_atomic_storesi = 1115,
  CODE_FOR_atomic_storedi = 1116,
  CODE_FOR_atomic_addsi = 1117,
  CODE_FOR_atomic_orsi = 1118,
  CODE_FOR_atomic_xorsi = 1119,
  CODE_FOR_atomic_andsi = 1120,
  CODE_FOR_atomic_adddi = 1121,
  CODE_FOR_atomic_ordi = 1122,
  CODE_FOR_atomic_xordi = 1123,
  CODE_FOR_atomic_anddi = 1124,
  CODE_FOR_atomic_fetch_addsi = 1125,
  CODE_FOR_atomic_fetch_orsi = 1126,
  CODE_FOR_atomic_fetch_xorsi = 1127,
  CODE_FOR_atomic_fetch_andsi = 1128,
  CODE_FOR_atomic_fetch_adddi = 1129,
  CODE_FOR_atomic_fetch_ordi = 1130,
  CODE_FOR_atomic_fetch_xordi = 1131,
  CODE_FOR_atomic_fetch_anddi = 1132,
  CODE_FOR_atomic_exchangesi = 1133,
  CODE_FOR_atomic_exchangedi = 1134,
  CODE_FOR_atomic_cas_value_strongsi = 1135,
  CODE_FOR_atomic_cas_value_strongdi = 1136,
  CODE_FOR_mulditi3 = 1177,
  CODE_FOR_umulditi3 = 1178,
  CODE_FOR_usmulditi3 = 1179,
  CODE_FOR_mulsidi3 = 1180,
  CODE_FOR_umulsidi3 = 1181,
  CODE_FOR_usmulsidi3 = 1182,
   CODE_FOR_maddv1sfsf4 = CODE_FOR_nothing,
   CODE_FOR_maddhfsf4 = CODE_FOR_nothing,
  CODE_FOR_maddohfsf4 = 1183,
  CODE_FOR_clzsi2 = 1184,
  CODE_FOR_paritysi2 = 1185,
  CODE_FOR_movdi = 1186,
  CODE_FOR_pulp_omp_barrier = 1187,
  CODE_FOR_pulp_omp_critical_start = 1188,
  CODE_FOR_pulp_omp_critical_end = 1189,
  CODE_FOR_OffsetedReadNonVol_m1 = 1190,
  CODE_FOR_movsi = 1191,
  CODE_FOR_movv2hi = 1192,
  CODE_FOR_movv4qi = 1193,
  CODE_FOR_movmisalignv4qi = 1194,
  CODE_FOR_movmisalignv2hi = 1195,
  CODE_FOR_movmisalignv2hf = 1196,
  CODE_FOR_movmisalignv2ohf = 1197,
  CODE_FOR_movmisalignohf = 1198,
  CODE_FOR_movmisalignsf = 1199,
  CODE_FOR_movmisalignsi = 1200,
  CODE_FOR_movhi = 1201,
  CODE_FOR_movqi = 1202,
  CODE_FOR_movhf = 1203,
  CODE_FOR_movohf = 1204,
  CODE_FOR_movsf = 1205,
  CODE_FOR_movdf = 1206,
  CODE_FOR_clear_cache = 1207,
  CODE_FOR_movmemsi = 1208,
  CODE_FOR_vec_initv2hf_internal_f = 1209,
  CODE_FOR_vec_initv2ohf_internal_f = 1210,
  CODE_FOR_vec_initv2hf = 1211,
  CODE_FOR_vec_initv2ohf = 1212,
  CODE_FOR_vec_initv2hi = 1213,
  CODE_FOR_vec_initv4qi = 1214,
  CODE_FOR_movv2hf = 1215,
  CODE_FOR_movv2ohf = 1216,
  CODE_FOR_movv1sf = 1217,
  CODE_FOR_floatv2hiv2hf2 = 1218,
  CODE_FOR_floatv2hiv2ohf2 = 1219,
  CODE_FOR_floatunsv2hiv2hf2 = 1220,
  CODE_FOR_floatunsv2hiv2ohf2 = 1221,
  CODE_FOR_fix_truncv2hfv2hi2 = 1222,
  CODE_FOR_fix_truncv2ohfv2hi2 = 1223,
  CODE_FOR_fixuns_truncv2hfv2hi2 = 1224,
  CODE_FOR_fixuns_truncv2ohfv2hi2 = 1225,
  CODE_FOR_vec_unpacks_hi_v2hf = 1226,
  CODE_FOR_vec_unpacks_hi_v2ohf = 1227,
  CODE_FOR_vec_pack_v4qi = 1228,
  CODE_FOR_vec_permv2hf = 1229,
  CODE_FOR_vec_permv2ohf = 1230,
  CODE_FOR_vec_permv2hi = 1231,
  CODE_FOR_vec_permv4qi = 1232,
  CODE_FOR_vec_set_firstv2hf = 1233,
  CODE_FOR_vec_set_firstv2ohf = 1234,
  CODE_FOR_vec_set_firstv2hi = 1235,
  CODE_FOR_vec_set_firstv4qi = 1236,
  CODE_FOR_vec_setv2hf = 1237,
  CODE_FOR_vec_setv2ohf = 1238,
  CODE_FOR_vec_setv2hi = 1239,
  CODE_FOR_vec_setv4qi = 1240,
  CODE_FOR_fmav2hf4 = 1241,
  CODE_FOR_fmav2ohf4 = 1242,
  CODE_FOR_cplxmulsv2hi2 = 1243,
  CODE_FOR_cplxmulsv2hi2_div2 = 1244,
  CODE_FOR_cplxmulsv2hi2_div4 = 1245,
  CODE_FOR_cplxmulsv2hi2_div8 = 1246,
  CODE_FOR_vcondv2hiv2hf = 1247,
  CODE_FOR_vcondv2hiv2ohf = 1248,
  CODE_FOR_vcondv2hiv2hi = 1249,
  CODE_FOR_vcondv4qiv4qi = 1250,
  CODE_FOR_vconduv2hiv2hi = 1251,
  CODE_FOR_vconduv4qiv4qi = 1252,
  CODE_FOR_condjump = 1253,
  CODE_FOR_cbranchqi4 = 1254,
  CODE_FOR_cbranchsi4 = 1255,
  CODE_FOR_cbranchdi4 = 1256,
  CODE_FOR_cbranchsf4 = 1257,
  CODE_FOR_cbranchdf4 = 1258,
  CODE_FOR_cbranchhf4 = 1259,
  CODE_FOR_cbranchohf4 = 1260,
  CODE_FOR_cstoresi4 = 1261,
  CODE_FOR_cstoredi4 = 1262,
  CODE_FOR_cstoresf4 = 1263,
  CODE_FOR_cstoredf4 = 1264,
  CODE_FOR_cstorehf4 = 1265,
  CODE_FOR_cstoreohf4 = 1266,
  CODE_FOR_indirect_jump = 1267,
  CODE_FOR_tablejump = 1268,
  CODE_FOR_prologue = 1269,
  CODE_FOR_epilogue = 1270,
  CODE_FOR_sibcall_epilogue = 1271,
  CODE_FOR_return = 1272,
  CODE_FOR_eh_return = 1273,
  CODE_FOR_doloop_end = 1274,
  CODE_FOR_sibcall = 1275,
  CODE_FOR_sibcall_value = 1276,
  CODE_FOR_call = 1277,
  CODE_FOR_call_value = 1278,
  CODE_FOR_untyped_call = 1279,
  CODE_FOR_mem_thread_fence = 1280,
  CODE_FOR_atomic_compare_and_swapsi = 1281,
  CODE_FOR_atomic_compare_and_swapdi = 1282,
  CODE_FOR_atomic_test_and_set = 1283
};

const unsigned int NUM_INSN_CODES = 1284;
