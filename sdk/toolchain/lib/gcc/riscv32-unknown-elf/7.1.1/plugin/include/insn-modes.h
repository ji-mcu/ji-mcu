...
#define HAVE_SImode
  NVmode,                  /* config/riscv/riscv-modes.def:43 */
#define HAVE_NVmode
  CVmode,                  /* config/riscv/riscv-modes.def:44 */
#define HAVE_CVmode
  HVmode,                  /* config/riscv/riscv-modes.def:45 */
#define HAVE_HVmode
  BVmode,                  /* config/riscv/riscv-modes.def:46 */
#define HAVE_BVmode
...
#define HAVE_CHImode
  CBVmode,                 /* machmode.def:245 */
#define HAVE_CBVmode
  CHVmode,                 /* machmode.def:245 */
#define HAVE_CHVmode
  CCVmode,                 /* machmode.def:245 */
#define HAVE_CCVmode
  CNVmode,                 /* machmode.def:245 */
#define HAVE_CNVmode
...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case NVmode: return 4;
    case CVmode: return 4;
    case HVmode: return 4;
    case BVmode: return 4;
    ...
    case CBVmode: return 8;
    case CHVmode: return 8;
    case CCVmode: return 8;
    case CNVmode: return 8;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case NVmode: return 1;
    case CVmode: return 1;
    case HVmode: return 1;
    case BVmode: return 1;
    ...
    case CBVmode: return 2;
    case CHVmode: return 2;
    case CCVmode: return 2;
    case CNVmode: return 2;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case NVmode: return NVmode;
    case CVmode: return CVmode;
    case HVmode: return HVmode;
    case BVmode: return BVmode;
    ...
    case CBVmode: return BVmode;
    case CHVmode: return HVmode;
    case CCVmode: return CVmode;
    case CNVmode: return NVmode;
...
mode_unit_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case CHImode: return 2;
    case CBVmode: return 4;
    case CHVmode: return 4;
    case CCVmode: return 4;
    case CNVmode: return 4;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case NVmode: return 4*BITS_PER_UNIT;
    case CVmode: return 4*BITS_PER_UNIT;
    case HVmode: return 4*BITS_PER_UNIT;
    case BVmode: return 4*BITS_PER_UNIT;
    ...
    case CBVmode: return 4*BITS_PER_UNIT;
    case CHVmode: return 4*BITS_PER_UNIT;
    case CCVmode: return 4*BITS_PER_UNIT;
    case CNVmode: return 4*BITS_PER_UNIT;
